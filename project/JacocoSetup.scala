...
object JacocoSetup {
  ...
  def jacocoProjectExcludes(): Seq[String] = {
    Seq(
      ...
      "**.controller.PartitioningController.class",
      "**.controller.PartitioningController\\$class.class",
      "za/co/absa/atum/server/api/v2/controller/PartitioningController.class",
