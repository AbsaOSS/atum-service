...
object GetPartitioningAdditionalDataEndpointUnitTests extends ZIOSpecDefault with TestData {
  ...
  private val getPartitioningAdditionalDataServerEndpoint = Endpoints.getPartitioningAdditionalDataEndpoint
  ...
  override def spec: Spec[TestEnvironment with Scope, Any] = {
    ...
    val backendStub = TapirStubInterpreter(SttpBackendStub.apply(new RIOMonadError[PartitioningController]))
      .whenServerEndpoint(getPartitioningAdditionalDataServerEndpoint)
      .thenRunLogic()
      .backend()

    suite("GetPartitioningAdditionalDataEndpointSuite")(
