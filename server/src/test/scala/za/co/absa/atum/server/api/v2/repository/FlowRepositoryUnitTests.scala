...
object FlowRepositoryUnitTests extends ZIOSpecDefault with TestData {
  ...
  when(getFlowCheckpointsV2Mock.apply(GetFlowCheckpointsArgs(1, 1, 1L, None, None, None, None, None)))
    .thenReturn(
      ZIO.right(
        Seq(
  ...
  when(getFlowCheckpointsV2Mock.apply(GetFlowCheckpointsArgs(2, 1, 1L, None, None, None, None, None)))
    .thenReturn(ZIO.right(Seq(Row(FunctionStatus(11, "success"), None))))
  when(getFlowCheckpointsV2Mock.apply(GetFlowCheckpointsArgs(3, 1, 1L, None, None, None, None, None)))
    ...
    suite("FlowRepositoryIntegrationSuite")(
      suite("GetFlowCheckpointsV2Suite")(
        test("Returns expected Right with CheckpointV2DTO without properties") {
          for {
            result <- FlowRepository.getFlowCheckpoints(1, 1, 1L, None, None, None, None, None, includeProperties = false)
        ...
        test("Returns expected Right with CheckpointV2DTO with properties") {
          for {
            result <- FlowRepository.getFlowCheckpoints(1, 1, 1L, None, None, None, None, None, includeProperties = true)
          } yield assertTrue(
        ...
        test("Returns expected Right with CheckpointV2DTO") {
          for {
            result <- FlowRepository.getFlowCheckpoints(2, 1, 1L, None, None, None, None, None, includeProperties = false)
          } yield assertTrue(result == ResultNoMore(Seq.empty[CheckpointWithPartitioningDTO]))
        },
        test("Returns expected DatabaseError") {
          assertZIO(FlowRepository.getFlowCheckpoints(3, 1, 1L, None, None, None, None, None, includeProperties = false).exit)(
