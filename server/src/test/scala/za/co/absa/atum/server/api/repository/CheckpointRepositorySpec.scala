...
class CheckpointRepositorySpec extends ZIOSpecDefault {

  private val checkpointDTO1 = CheckpointDTO(
    id = UUID.randomUUID(),
    name = "name",
    author = "author",
  ...
  private val checkpointDTO2 = checkpointDTO1.copy(id = UUID.randomUUID())
