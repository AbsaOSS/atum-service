...
object GetFlowPartitioningsV2EndpointUnitTests extends ZIOSpecDefault with Endpoints with TestData {
  ...
  private val getFlowPartitioningsServerEndpoint =
    getFlowPartitioningsEndpointV2.zServerLogic({ case (flowId: Long, limit: Option[Int], offset: Option[Long]) =>
  ...
  override def spec: Spec[TestEnvironment with Scope, Any] = {
    ...
    suite("GetFlowPartitioningsV2EndpointSuite")(
