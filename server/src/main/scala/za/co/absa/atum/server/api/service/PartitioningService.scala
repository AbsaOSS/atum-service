...
import za.co.absa.atum.model.dto.{AdditionalDataDTO, AdditionalDataPatchDTO, AdditionalDataSubmitDTO, CheckpointDTO, CheckpointQueryDTO, InitialAdditionalDataDTO, MeasureDTO, PartitioningDTO, PartitioningSubmitDTO}
